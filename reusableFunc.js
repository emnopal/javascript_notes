...
const salesMoreThanOneMil = books.filter(book => book.sales > 1000000);
console.log(salesMoreThanOneMil);

const greatAuthors = salesMoreThanOneMil.map(book => `${book.author} adalah penulis buku ${book.title} yang sangat hebat!`);
